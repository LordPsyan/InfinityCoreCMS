...
<tr class="{topicrow.ROW_CLASS}h{topicrow.CLASS_NEW} row-forum">
	...
	<td class="{topicrow.ROW_CLASS}h{topicrow.CLASS_NEW} row-forum" width="100%" style="background: none; cursor: pointer;" onclick="window.location.href='{topicrow.U_VIEW_TOPIC}'">
