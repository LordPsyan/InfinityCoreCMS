...
<!-- <input type="hidden" name="domains" value="{GSEARCH_SITE};www.infinitycore.org" /> -->
...
<!-- <input type="radio" name="sitesearch" value="www.infinitycore.org" /><span class="gensmall">InfinityCoreCMS</span> -->
</div>
<!-- ELSE -->
...
<!-- <input type="radio" name="sitesearch" value="www.infinitycore.org" /><span class="gensmall">InfinityCoreCMS</span><br /> -->
</div>
<!-- ENDIF -->
</center>
</form>
