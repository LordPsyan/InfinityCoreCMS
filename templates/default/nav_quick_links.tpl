		...
		<div id="main_links2" class="nav-menu">
			<table class="forumline-no2" width="100%" cellspacing="0" cellpadding="2" border="0">
				...
				<tr>
					...
					<td class="genmed" align="left"><a href="{U_CMS_ACP}">{L_LINK_ACP}</a></td>
				</tr>
				<tr>
					<td align="left" width="8">{IMG_NAV_MENU_SEP}</td>
					<td class="genmed" align="left"><a href="{U_CMS}">{L_LINK_CMS}</a></td>
				</tr>
				<!-- ENDIF -->
				<tr>
					<td align="left" width="8">{IMG_NAV_MENU_SEP}</td>
					<td class="genmed" align="left"><a href="{U_PORTAL}">{L_LINK_HOME}</a></td>
				</tr>
				<!-- IF S_LOGGED_IN -->
				<tr>
					<td width="8" align="left">{IMG_NAV_MENU_SEP}</td>
					<td class="genmed" align="left"><a href="{U_PROFILE}">{L_LINK_PROFILE}</a></td>
				</tr>
				<!-- ENDIF -->
				<tr>
					<td align="left" width="8">{IMG_NAV_MENU_SEP}</td>
					<td class="genmed" align="left"><a href="{U_INDEX}">{L_LINK_FORUM}</a></td>
				</tr>
				<tr>
					<td align="left" width="8">{IMG_NAV_MENU_SEP}</td>
					<td class="genmed" align="left"><a href="{U_BOARDRULES}">{L_LINK_BOARDRULES}</a></td>
				</tr>
				<tr>
					<td align="left" width="8">{IMG_NAV_MENU_SEP}</td>
					<td class="genmed" align="left"><a href="{U_FAQ}">{L_LINK_FAQ}</a></td>
				</tr>
				<tr>
					<td align="left" width="8">{IMG_NAV_MENU_SEP}</td>
					<td class="genmed" align="left"><a href="{U_SEARCH}">{L_LINK_SEARCH}</a></td>
				</tr>
				<tr>
					<td align="left" width="8">{IMG_NAV_MENU_SEP}</td>
					<td class="genmed" align="left"><a href="{U_SITEMAP}">{L_LINK_SITEMAP}</a></td>
				</tr>
				<tr>
					<td width="8" align="left">{IMG_NAV_MENU_SEP}</td>
					<td class="genmed" align="left"><a href="{U_ALBUM}">{L_LINK_ALBUM}</a></td>
				</tr>
				<tr>
					<td align="left" width="8">{IMG_NAV_MENU_SEP}</td>
					<td class="genmed" align="left"><a href="{U_CALENDAR}">{L_LINK_CALENDAR}</a></td>
				</tr>
				<tr>
					<td width="8" align="left">{IMG_NAV_MENU_SEP}</td>
					<td class="genmed" align="left"><a href="{U_DOWNLOADS_NAV}">{L_LINK_DOWNLOADS}</a></td>
				</tr>
				<!-- IF S_LOGGED_IN -->
				<tr>
					<td align="left" width="8">{IMG_NAV_MENU_SEP}</td>
	...
	<td class="row5">
		<div id="news2_links2" class="nav-menu">
			<table class="forumline-no2" width="100%" cellspacing="0" cellpadding="2" border="0">
				<tr>
					<td width="8" align="left">{IMG_NAV_MENU_SEP}</td>
					<td class="genmed" align="left"><a href="{U_PORTAL_NEWS_CAT}">{L_LINK_NEWS_CAT}</a></td>
				</tr>
				<tr>
					<td width="8" align="left">{IMG_NAV_MENU_SEP}</td>
					<td class="genmed" align="left"><a href="{U_PORTAL_NEWS_ARC}">{L_LINK_NEWS_ARC}</a></td>
				</tr>
				<!-- IF S_LOGGED_IN -->
				<tr>
					<td align="left" width="8">{IMG_NAV_MENU_SEP}</td>
					<td class="genmed" align="left"><a href="{U_SEARCH_NEW}">{L_LINK_NEW_MESSAGES}</a></td>
				</tr>
				<!-- ENDIF -->
			</table>
		</div>
	...
	<td class="row5">
		<div id="users_links2" class="nav-menu">
			<table class="forumline-no2" width="100%" cellspacing="0" cellpadding="2" border="0">
				<tr>
					<td width="8" align="left">{IMG_NAV_MENU_SEP}</td>
					<td class="genmed" align="left"><a href="{U_MEMBERLIST}">{L_LINK_MEMBERLIST}</a></td>
				</tr>
				<tr>
					<td width="8" align="left">{IMG_NAV_MENU_SEP}</td>
					<td class="genmed" align="left"><a href="{U_GROUP_CP}">{L_LINK_USERGROUPS}</a></td>
				</tr>
				<tr>
					<td width="8" align="left">{IMG_NAV_MENU_SEP}</td>
					<td class="genmed" align="left"><a href="{U_RANKS}">{L_LINK_RANKS}</a></td>
				</tr>
				<tr>
					<td width="8" align="left">{IMG_NAV_MENU_SEP}</td>
					<td class="genmed" align="left"><a href="{U_STAFF}">{L_LINK_STAFF}</a></td>
				</tr>
			</table>
		</div>
...
<tr>
	<td class="row5">
		<div id="style_select2" class="nav-menu"><table class="forumline-no2" width="100%" cellspacing="0" cellpadding="2" border="0"><tr><td class="genmed" align="center">{STYLE_SELECT_H}</td></tr></table></div>
