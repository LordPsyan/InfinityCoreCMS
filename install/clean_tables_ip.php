...
// Language
$lang['title'] = 'Clean InfinityCoreCMS SQL tables';
$lang['incompatible_dbms'] = 'This script will only work with MySQL';
$lang['explain'] = 'This script has generated a list with fieldnames and tables in your InfinityCoreCMS DB which have (probably) been created by MODs.<br /><br />You can prevent a fieldname, table or configuration setting from being dropped by removing the check in front of that specific item. After you have made sure that no valuable fields, tables or configuration settings will be dropped you can click \'Clean tables\' to drop the selected items.<br /><br /><br /><b>Note that it is entirely your own responsibility to create a backup of your SQL database before running this script</b>';
...
<head>
	...
	<meta name="author" content="InfinityCoreCMS Team" />
	<title><?php echo $lang['title']; ?> :: InfinityCoreCMS</title>
		...
		<div id="top_logo">
			...
			<tr>
				<td height="150" align="left" valign="middle">
					<a href="http://www.infinitycore.org" title="InfinityCoreCMS"><img src="./images/logo_ip.png" alt="InfinityCoreCMS" title="InfinityCoreCMS" /></a>
				</td>
			</tr>
			</table>
		</div>
		...
		<table class="empty-table" width="100%" cellspacing="0" cellpadding="0" border="0">
			<tr>
				<td nowrap="nowrap" width="45%" align="left">
					<span class="copyright">&nbsp;Powered by <a href="http://www.infinitycore.org/" target="_blank">InfinityCoreCMS</a> based on <a href="http://www.phpbb.com/" target="_blank">phpBB</a></span>
				</td>
