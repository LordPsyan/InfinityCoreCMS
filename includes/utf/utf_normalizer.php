...
class utf_normalizer
{
	...
	*/
	function cleanup(&$str)
	{
		...
		{
			include(IP_ROOT_PATH . 'includes/utf/data/utf_nfc_qc.' . PHP_EXT);
		}

		if (!isset($GLOBALS['utf_canonical_decomp']))
		{
			include(IP_ROOT_PATH . 'includes/utf/data/utf_canonical_decomp.' . PHP_EXT);
		}
	...
	*/
	function recompose($str, $pos, $len, &$qc, &$decomp_map)
	{
		...
		{
			include(IP_ROOT_PATH . 'includes/utf/data/utf_normalizer_common.' . PHP_EXT);
		}

		// Load the canonical composition table
		if (!isset($utf_canonical_comp))
		{
			include(IP_ROOT_PATH . 'includes/utf/data/utf_canonical_comp.' . PHP_EXT);
		}
