...
$year_start = gmdate('Y', gmmktime(0, 0, 0, 1, 1, $current_year - $last_cluster_begin));
$year_end = gmdate('Y', gmmktime(0, 0, 0, 1, 1, $year_start + $years_span));
$last_cluster_year = gmdate('Y', gmmktime(0, 0, 0, 1, 1, $current_year - $first_cluster_end));
...
for ($i = 1; $i < ($total_clusters - 1); $i++)
{
	...
	$year_start = gmdate('Y', gmmktime(0, 0, 0, 1, 1, $year_start + $years_span));
	$year_end = gmdate('Y', gmmktime(0, 0, 0, 1, 1, $year_end + $years_span));
}
