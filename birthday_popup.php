...
$l_greeting = ($user_birthday2 == $date_today) ? sprintf($lang['Birthday_greeting_today'], gmdate('Y') - realdate('Y', $user->data['user_birthday'])) : sprintf($lang['Birthday_greeting_prev'], gmdate('Y') - realdate('Y', $user->data['user_birthday']), realdate(str_replace('Y', '', $lang['DATE_FORMAT_BIRTHDAY']), $user->data['user_birthday']));
