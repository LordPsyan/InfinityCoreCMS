...
function sudoku_tasks($Sud_user_id, $pack, $num, $level)
{
	...
	if ($row['entrys'] > 1)
	{
		...
		$sql = " INSERT INTO " . SUDOKU_USERS . " (user_id,game_pack,game_num,game_level,line_1,line_2,line_3,line_4,line_5,line_6,line_7,line_8,line_9)
		VALUES ($Sud_user_id,$pack,$num,$level,'" . $row['line_1'] . "','" . $row['line_2'] . "','" . $row['line_3'] . "','" . $row['line_4'] . "','" . $row['line_5'] . "','" . $row['line_6'] . "','" . $row['line_7'] . "','" . $row['line_8'] . "','" . $row['line_9'] . "')";
		$db->sql_query($sql);
	}
	...
	if (!$row)
	{
		...
		$sql = " INSERT INTO " . SUDOKU_STATS . " (user_id, played, points)
		VALUES ($Sud_user_id, '$s_games','$s_points')";
		$db->sql_query($sql);
	}
	...
	$sql = " INSERT INTO " . SUDOKU_SESSIONS . " (user_id, session_time)
		VALUES ($Sud_user_id, $time)";
	$db->sql_query($sql);
